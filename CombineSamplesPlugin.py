...
class CombineSamplesPlugin:
 def input(self, inputfile):
  self.COMBINED_PARTITIONS_DIR = inputfile
 def run(self):
  pass
 def output(self, outputfile):
  OUT_PTR = outputfile+".ptr.txt"
  OUT_ABUNDANCE = outputfile+".abundance.txt"

  merge_time_series(self.COMBINED_PARTITIONS_DIR, OUT_PTR, OUT_ABUNDANCE)
